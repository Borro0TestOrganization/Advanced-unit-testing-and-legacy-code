...
{
    public int _maxTeamMembersTeam1;
    public int _maxTeamMembersTeam2;
...
{
    private readonly AltenFunEvent _altenFunEvent;
    private readonly EmployeeDatabase _employeeDatabase;
    List<string> _participants;

    public FunEventHost(AltenFunEvent altenFunEvent)
    {
