namespace LegacyCode._3_MethodWrap.Example.Result {
    public class MethodWrapTests {
        [Test]
        public void SchedulesMeetingNoTimeConflict() {
            // Arrange
        ...
        [Test]
        public void TestSchedulesMeetingPreventsTimeConflict() {
            // Arrange
            var meeting1 = new FunEvent(1, "New Meeting 1", "Description 1", "05:00");
        ...
        [Test]
        public void TestSchedulesMeetingAllowsDifferentTimes() {
            // Arrange
            var meeting1 = new FunEvent(1, "New Meeting 1", "Description 1", "05:00");
            var meeting2 = new FunEvent(2, "New Meeting 2", "Description 2", "06:00");
            string location = "Room A";
